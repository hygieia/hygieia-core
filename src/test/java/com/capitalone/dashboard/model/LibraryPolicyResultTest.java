...
public class LibraryPolicyResultTest {
    ...
    public void addThreat() {
        ...
        assertEquals(threat.getComponents().iterator().next(), "component1##Open:Review Requested##0");
        ...
        result.addThreat(LibraryPolicyType.License, LibraryPolicyThreatLevel.Critical, LibraryPolicyThreatDisposition.Open, "Open:Won't Fix", "component2","0");
        assertEquals(result.getThreats().size(), 1);
        assertEquals(result.getThreats().keySet().size(), 1);
        assertEquals(result.getThreats().values().size(), 1);
        assertEquals(result.getThreats().keySet().iterator().next(), LibraryPolicyType.License);
        ...
        assertEquals(threat.getLevel(), LibraryPolicyThreatLevel.Critical);
        assertTrue(threat.getComponents().contains( "component1##Open:Review Requested##0"));
        assertTrue(threat.getComponents().contains( "component2##Open:Won't Fix##0"));
        assertEquals(threat.getDispositionCounts().size(), 1);
        ...
        assertTrue(threat.getComponents().contains( "component1##Open:Review Requested##0"));
        assertTrue(threat.getComponents().contains( "component2##Open:Won't Fix##0"));
        assertTrue(threat.getComponents().contains( "component3##Closed:False Positive##0"));
        ...
        assertTrue(threat.getComponents().contains( "component4##Open:Legal Review Requested##0"));
        assertEquals(threat.getDispositionCounts().size(), 1);
        assertEquals(threat.getDispositionCounts().get(LibraryPolicyThreatDisposition.Open).intValue(), 1);
        ...
        assertEquals(threat.getCount(), 1);
        assertEquals(threat.getLevel(), LibraryPolicyThreatLevel.High);
        assertTrue(threat.getComponents().contains( "component5##Open:Unconfirmed##0"));
        assertEquals(threat.getDispositionCounts().size(), 1);
    }
